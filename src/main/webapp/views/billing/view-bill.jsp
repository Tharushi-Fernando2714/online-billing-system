...
<body>
    ...
    <div class="container-fluid">
            <main class="px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary no-print">
                    <h1 class="h2 text-primary-dark fw-bold">Bill Details</h1>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <h5 class="text-primary-medium mb-3">
                                            <i class="fas fa-user me-2"></i>Bill To
                                        </h5>
                                        <h6 class="mb-2 text-primary-dark">${bill.customer.customerName}</h6>
                                        <p class="mb-1 text-primary-medium">
                                ...
                                <!-- Items Table -->
                                <h5 class="mb-3 text-primary-dark">
