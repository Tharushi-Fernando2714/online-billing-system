    ...
    <div class="container-fluid"> 
            <main class="px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary">
                    <h1 class="h2 text-primary-dark fw-bold">${pageTitle}</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="${pageContext.request.contextPath}/bill/create" class="btn btn-primary">
                                <i class="fas fa-plus"></i> New Bill
                            </a>
                            <button type="button" class="btn btn-outline-primary" onclick="exportBills('csv')">
                ...
                <div class="row mb-4 g-3">
                        ...
                        <div class="card stats-card total shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="text-primary-medium mb-0">Total Bills</h6>
                                    <i class="fas fa-file-invoice" style="color: var(--primary);"></i>
                                </div>
                                <h3 class="mb-1 text-primary-dark fw-bold">${statistics.totalBills}</h3>
                                <p class="mb-0 text-primary-medium small">
                    ...
                    <div class="col-md-3">
                        <div class="card stats-card paid shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="text-primary-medium mb-0">Paid Bills</h6>
                                    <i class="fas fa-check-circle" style="color: var(--accent-green);"></i>
                                </div>
                                <h3 class="mb-1 text-primary-dark fw-bold">${statistics.paidCount}</h3>
                    ...
                    <div class="col-md-3">
                        <div class="card stats-card pending shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="text-primary-medium mb-0">Pending Bills</h6>
                                    <i class="fas fa-clock" style="color: var(--accent-orange);"></i>
                                </div>
                                <h3 class="mb-1 text-primary-dark fw-bold">${statistics.pendingCount}</h3>
                    ...
                    <div class="col-md-3">
                        <div class="card stats-card cancelled shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="text-primary-medium mb-0">Cancelled</h6>
                                    <i class="fas fa-times-circle" style="color: var(--accent-red);"></i>
                                </div>
                                <h3 class="mb-1 text-primary-dark fw-bold">${statistics.cancelledCount}</h3>
                                <p class="mb-0 text-primary-medium small">
                                            ...
                                            <c:forEach items="${bills}" var="bill">
                                                <tr data-bill-id="${bill.billId}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <small class="text-primary-medium">
                                                            <fmt:formatDate value="${bill.billTime}" pattern="hh:mm a"/>
                                                        </small>
                                                    </td>
                                                    <td>
                                                        <span class="text-primary-dark">${bill.customerName}</span>
                                                        <br>
                                                        <small class="text-primary-medium">${bill.customerAccountNumber}</small>
                                                    </td>
                                                    <td>
                                                        <span class="badge rounded-pill" style="background-color: var(--primary-light); color: white;">
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <span class="badge rounded-pill" style="background-color: var(--primary-pale); color: var(--primary-dark);">
                                                                    ${bill.paymentStatus}
                                                                </span>
                                                            </c:otherwise>
                                                        </c:choose>
                                            ...
                                            <tr>
                                                <td colspan="8" class="text-center py-5">
                                                    <div style="color: var(--primary-light);">
                                                        ...
                                                        <p class="text-primary-medium mb-3">No bills found</p>
