            ...
            <main class="px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary">
                    <h1 class="h2 text-primary-dark fw-bold">
                        <i class="fas fa-box-open me-2" style="color: var(--primary-medium);"></i>
                        Add New Item
                    </h1>
                        ...
                        <form action="${pageContext.request.contextPath}/item/add" method="post" id="addItemForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    <label for="description" class="form-label">
                                        <i class="fas fa-align-left me-1" style="color: var(--primary-medium);"></i>
                                        Description
                                    </label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="author" class="form-label">
                                            <i class="fas fa-user-edit me-1" style="color: var(--primary-medium);"></i>
                                            Author
                                        </label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="publisher" class="form-label">
                                            <i class="fas fa-building me-1" style="color: var(--primary-medium);"></i>
                                            Publisher
                                        </label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="isbn" class="form-label">
                                            <i class="fas fa-fingerprint me-1" style="color: var(--primary-medium);"></i>
                                            ISBN
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            <i class="fas fa-bookmark me-1" style="color: var(--primary-medium);"></i>
                                            Item Type
                                        </label>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">
                                            <i class="fas fa-chart-line me-1" style="color: var(--primary-medium);"></i>
                                            Profit Margin
                                        </label>
