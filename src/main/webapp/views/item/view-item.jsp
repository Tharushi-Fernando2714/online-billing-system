            ...
            <main class="px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary">
                    <h1 class="h2 text-primary-dark fw-bold">
                        <i class="fas fa-cube me-2" style="color: var(--primary-medium);"></i>
                        Item Details
                    </h1>
                    ...
                    <div class="card-body">
                                ...
                                <div class="info-section">
                                    ...
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <tr>
                                            <th>Category:</th>
                                            <td>
                                                <span class="badge" style="background-color: var(--cream); color: var(--primary-medium);">
                                                    ${item.categoryName}
                                                </span>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="text-primary-medium">units</span>
                        ...
                        <c:if test="${not empty item.description}">
                            <div class="description-box mt-3">
                                <h5 class="text-primary-dark mb-2">
                                    <i class="fas fa-align-left me-2" style="color: var(--primary-medium);"></i>
                                    Description
                                </h5>
