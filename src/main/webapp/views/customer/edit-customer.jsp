            ...
            <main class="px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary">
                    <h1 class="h2 text-primary-dark fw-bold">
                        <i class="fas fa-user-edit me-2" style="color: var(--primary-medium);"></i>
                        Edit Customer
                    </h1>
                        ...
                        <form action="${pageContext.request.contextPath}/customer/edit" method="post">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            <i class="fas fa-id-badge text-primary-medium me-1"></i>
                                            Account Number
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            <i class="fas fa-id-card text-primary-medium me-1"></i>
                                            NIC Number
                                        </label>
                                        <div class="readonly-field">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            <i class="fas fa-calendar-plus text-primary-medium me-1"></i>
                                            Registered On
                                        </label>
                                        <div class="readonly-field">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            <i class="fas fa-toggle-on text-primary-medium me-1"></i>
                                            Current Status
                                        </label>
                                        <div class="mt-2">
