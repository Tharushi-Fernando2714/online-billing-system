    ...
    <div class="container-fluid">  
        ...
        <main class="px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-primary">
                <h1 class="h2 text-primary-dark fw-bold">Dashboard</h1>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stat card-stat-customers shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <h3 class="fw-bold text-primary-dark mb-1">${dashboardStats.totalCustomers}</h3>
            ...
            <div class="mb-4">
                ...
                <% if (!canManageItems) { %>
                    <div class="row g-4 mt-2">
                        <div class="col-12">
                            <div class="alert alert-info border-0 shadow-sm" style="background-color: #dbeafe; border-left: 4px solid var(--primary);">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-lg-12">
                        <div class="alert border-0 shadow-sm" role="alert" 
                             style="background-color: #fef2f2; border-left: 4px solid var(--accent-red);">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i class="fas fa-exclamation-circle fs-4" style="color: var(--accent-red);"></i>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="alert-heading mb-1 text-primary-dark">Critical Stock Alert</h6>
